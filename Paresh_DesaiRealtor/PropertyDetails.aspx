            ...
            <div style="float: left; width: 100%; background: white; border-radius: 6px; padding:10px;">
                ...
                <div style="float: left; width: 100%; margin-bottom: 12px;">
                    ...
                    <div style="float: left; width: 33%; margin-top: 20px;">
                        <h2 style="margin-bottom: 5px; font-family:arial; font-size: 18px;">Harjinder Sekhon & Manjit Sekhon</h2>
                        <p style="margin-bottom: 5px; font-family:arial;">Sales Representative</p>
                        <p style="font-weight: bold; margin-bottom: 5px; font-family:arial;">E-Mail:<span style="font-weight: normal; margin: 0 0px 0 6px;">info@sekhonteam.com</span></p>
                        <p style="font-weight: bold; margin-bottom: 5px; font-family:arial;">Phone:<span style="font-weight: normal; margin: 0 0px 0 6px;">416-831-5410, 416-500-2091</span></p>
                    </div>
