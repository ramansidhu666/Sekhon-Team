...
namespace Property_cls
{
    public class cls_Property
    {
        ...
        public int InsertLetterHeads(string Name, string Source, string FirstImage, string SecondImage)
        {
            DateTime? fwd_date = null;
            int result = 0;
            try
            {
                ...
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "usp_InsertLetterHead";
                cmd.Parameters.AddWithValue("@Name", Name);
                cmd.Parameters.AddWithValue("@Image", FirstImage);
                cmd.Parameters.AddWithValue("@second_Image", SecondImage);
                cmd.Parameters.AddWithValue("@OrderNo", Source);
        ...
        public int InsertEnvelops(string Name, string Source, string FirstImage, string SecondImage)
        {
            DateTime? fwd_date = null;
            int result = 0;
            try
            {
                ...
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.CommandText = "usp_InsertEnvelop";
                cmd.Parameters.AddWithValue("@Name", Name);
                cmd.Parameters.AddWithValue("@Image", FirstImage);
                cmd.Parameters.AddWithValue("@second_Image", SecondImage);
                cmd.Parameters.AddWithValue("@OrderNo", Source);
