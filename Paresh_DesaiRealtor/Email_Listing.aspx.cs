    ...
    public partial class Email_Listing : System.Web.UI.Page
    {
        ...
        public string GetPropertyDetails()
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                html.AppendLine("<h2 style='font-weight:bold; font-size:16px;'>Harjinder Sekhon & Manjit Sekhonfor Property ID  " + dt.Rows[0]["MLS"].ToString() + ";</h2>");
                html.AppendLine("<h2 style='font-weight: bold; font-size: 16px;'>Message Received From:</h2>");
                html.AppendLine("<p style='float: left; margin: 0 40px 0 0;'>Phone Number:</p><span style='float:left;'>416-831-5410, 416-500-2091</span><br/>");
                ...
                html.AppendLine("<p>http://www.sekhonteam.com//</p>");
                ...
                html.AppendLine("<p>For more information visit <a href='#'>http://www.sekhonteam.com//</a> </p></div>");
                html.AppendLine("<div style='float:left; padding-left:12px;'>");
                html.AppendLine("<p style='margin:0px;'>Listed By</p><br/><p>Harjinder Sekhon & Manjit Sekhon<br/>Sales Representative</p>");
                ...
                html.AppendLine("<p style='float:left; margin:0 40px 0 0; font-weight:bold;'>Cell::</p><span style='float:left;'>416-831-5410, 416-500-2091</span><br/>'");
                ...
                html.AppendLine("<p style='float:left; margin:0 40px 0 0; font-weight:bold;'>E-mail:</p><span style='float:left;'>info@sekhonteam.com</span><br/>");
                html.AppendLine("<p style='float:left; margin:0 40px 0 0; font-weight:bold;'>Website:</p><span style='float:left;'>http://www.sekhonteam.com//</span><br/></div></div>");
                html.AppendLine("<div style='float:left; width:100%;'>");
