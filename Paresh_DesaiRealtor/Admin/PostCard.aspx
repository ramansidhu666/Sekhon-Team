                ...
                <div class="form-horizontal row-fluid">
                        ...
                        <div style="float: left; width: 97%; background-color: #8a5201; padding: 12px;">
                            ...
                            <div style="float: left; width: 60%; text-align: center; margin: 8px 0;">
                                <div style="float: left; width: 100%; text-align: center;">
                                    ...
                                    <h2 style="float: left; width: 100%; color: #1c1c1c; font-size: 28px; font-weight: bold; font-family: 'Times New Roman', Times, serif; font-style: italic; margin: 6px 0;">Harjinder Sekhon & Manjit Sekhon</h2>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Call: 416-831-5410, 416-500-2091</p>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Email: info@sekhonteam.com</p>
                                        <p style="float: left; width: 100%; color: #222222; font-family: 'Times New Roman', Times, serif; font-style: italic; font-size: 18px; margin: 2px 0;">Website: www.sekhonteam.com</p>
                    ...
                    <div class="newsltr_bg" id="feature_Back" style="display: none">
                        <div style="float: left; width: 100%; background-color: #FFF; padding: 12px;">
                            ...
                            <div style="float: left; width: 100%; margin: 8px 0; text-align: center; background-color: #101010; padding: 12px 0;">
                                <h2 style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 4px 0; font-weight: bold;">Harjinder Sekhon & Manjit Sekhon(Sales Representative)</h2>
                    ...
                    <div class="newsltr_bg" id="2nd_featured_back" style="display: none">
                        <div style="float: left; width: 100%; background-color: #FFF; padding: 12px;">
                            ...
                            <div style="float: left; width: 100%; margin: 8px 0; text-align: center; background-color: #101010; padding: 12px 0;">
                                <h2 style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 4px 0; font-weight: bold;">Harjinder Sekhon & Manjit Sekhon</h2>
                                <p style="float: left; width: 100%; color: white; font-family: Arial, Helvetica, sans-serif; font-size: 18px; margin: 2px 0;">Homelife / Miracle Realty Ltd,. Brokerage</p>
                            </div>
                        </div>
                    </div>
