...
{
    public partial class Envelop : System.Web.UI.Page
    {
        #region Global
        ...
        protected void btnUploadImage_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (FirstImg.PostedFile != null && FirstImg.PostedFile.FileName != "")
                {
                    ...
                    var subPath = Server.MapPath("~/Envelops");
                    ...
                    FirstImage = clsobj.GetURL() + "/Envelops/" + fileName;
                }
                if (SecondImg.PostedFile != null && SecondImg.PostedFile.FileName != "")
                {
                    ...
                    SecondImage =  clsobj.GetURL() + "/Envelops/" + fileName;
                }
               
                var source = OrderNo.SelectedValue;
                int AdminClientId = clsobj.InsertEnvelops(txtName.Text, source, FirstImage, SecondImage);

               

                txtName.Text = "";               

                Response.Redirect("~/Admin/EnvelopList.aspx?Id=0", false);
            }
