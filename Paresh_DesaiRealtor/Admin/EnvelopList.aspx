<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true"
    CodeBehind="EnvelopList.aspx.cs" Inherits="Property.Admin.EnvelopList" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('.cls_print').click(function () {                
                ...
                $.ajax({
                    type: "POST",
                    url: "/Newsletterfile.asmx/PrintEnvelop",
                    data: "{ EnvelopId: '" + NewsletterId + "'}",
                    dataType: "json",
            ...
            <div class="module">
                ...
                <div class="module-body">
                    <div id="Newsletter">
                        ...
                        <p>
                            <asp:Button ID="btnaddusers" runat="server" class="btn btn-primary" Text="Add Envelop" OnClick="btnaddusers_Click" />
                        </p>
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hdnID" runat="server" Value='<%#Eval("EnvelopId") %>' />
                                ...
                                <asp:TemplateField HeaderText="Delete">
                                    <ItemTemplate>
                                        <a id="id" href="EnvelopList.aspx?Id=<%#Eval("EnvelopId") %>">
                                ...
                                <asp:TemplateField HeaderText="Print">
                                    <ItemTemplate>
                                        <a id="print" class="cls_print" data-id="<%#Eval("EnvelopId") %>" href="#"><img src="admintemplate/images/print-icon.png" alt="" /></a>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                    ...
                    <div id="userlist" style="display: none;">
                        <p>
                            ...
                            <button class="btn btn-primary backbtn" type="button">Back to Envelop</button>
                        </p>
