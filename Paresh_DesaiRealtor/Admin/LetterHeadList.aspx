<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true"
    CodeBehind="NewsLetterList.aspx.cs" Inherits="Property.Admin.LetterHeadList" %>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('.cls_print').click(function () {                
                ...
                $.ajax({
                    type: "POST",
                    url: "/Newsletterfile.asmx/PrintLetterHead",
                    data: "{ LetterHeadId: '" + NewsletterId + "'}",
                    dataType: "json",
            ...
            <div class="module">
                ...
                <div class="module-body">
                    <div id="Newsletter">
                        ...
                        <p>
                            <asp:Button ID="btnaddusers" runat="server" class="btn btn-primary" Text="Add LetterHead" OnClick="btnaddusers_Click" />
                        </p>
                            ...
                            <Columns>
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="hdnID" runat="server" Value='<%#Eval("LetterHeadId") %>' />
                                        <asp:HiddenField ID="NewsLetterName" runat="server" Value='<%#Eval("Name") %>' />
                                ...
                                <asp:BoundField DataField="Name" ControlStyle-CssClass="NewsLetterName" HeaderText="Name" SortExpression="Name"></asp:BoundField>
                               
                                <asp:TemplateField HeaderText="Delete">
                                    <ItemTemplate>
                                        <a id="id" href="LetterHeadList.aspx?Id=<%#Eval("LetterHeadId") %>">
                                ...
                                <asp:TemplateField HeaderText="Print">
                                    <ItemTemplate>
                                        <a id="print" class="cls_print" data-id="<%#Eval("LetterHeadId") %>" href="#"><img src="admintemplate/images/print-icon.png" alt="" /></a>
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
                    ...
                    <div id="userlist" style="display: none;">
                        <p>
                            ...
                            <button class="btn btn-primary backbtn" type="button">Back to LetterHead</button>
                        </p>
