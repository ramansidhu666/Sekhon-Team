        ...
        protected void btnUploadImage_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (FirstImg.PostedFile != null && FirstImg.PostedFile.FileName != "")
                {
                    ...
                    var subPath = Server.MapPath("~/LetterHeads");
                    ...
                    FirstImage = clsobj.GetURL() + "/LetterHeads/" + fileName;
                }
                if (SecondImg.PostedFile != null && SecondImg.PostedFile.FileName != "")
                {
                    ...
                    SecondImage =  clsobj.GetURL() + "/LetterHeads/" + fileName;
                }
               
                var source = OrderNo.SelectedValue;
                int AdminClientId = clsobj.InsertLetterHeads(txtName.Text, source, FirstImage, SecondImage);

               

                txtName.Text = "";               

                Response.Redirect("~/Admin/LetterHeadList.aspx?Id=0", false);
            }
