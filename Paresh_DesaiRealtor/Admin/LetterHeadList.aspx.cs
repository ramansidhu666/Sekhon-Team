...
{
    public partial class LetterHeadList : System.Web.UI.Page
    {
        ...
        protected DataTable GetNewsLetter()
        {
            ...
            try
            {
                ...
                string str = "select * from [LetterHead]  order by OrderNo asc";

                SqlDataAdapter adp = new SqlDataAdapter(str, conn);
                adp.Fill(dt);
                dt.TableName = "LetterHead";
            }
            catch (Exception ex)
            { }
            finally
        ...
        {
            Response.Redirect("LetterHead.aspx");
        }
        ...
        protected void btnsendNewsLetter_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("LetterHeadList.aspx?Id=0");
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Delete from LetterHead where LetterHeadId in(" + SelectedIds + ")", conn);
        ...
        {
            SqlCommand cmd = new SqlCommand("Delete from LetterHead where LetterHeadId in(" + id + ")", conn);
            // SqlCommand cmd = new SqlCommand("delete from tblContactUs where Name='';", conn);
            conn.Open();
            cmd.ExecuteNonQuery();
            conn.Close();
