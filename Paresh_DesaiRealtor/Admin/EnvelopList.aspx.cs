...
{
    public partial class EnvelopList : System.Web.UI.Page
    {
        ...
        protected DataTable GetNewsLetter()
        {
            ...
            try
            {
                ...
                string str = "select * from [Envelop]  order by OrderNo asc";

                SqlDataAdapter adp = new SqlDataAdapter(str, conn);
                adp.Fill(dt);
                dt.TableName = "Envelop";
            }
            catch (Exception ex)
            { }
            finally
        ...
        {
            Response.Redirect("Envelop.aspx");
        }
        ...
        protected void btnsendNewsLetter_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("EnvelopList.aspx?Id=0");
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Delete from Envelop where EnvelopId in(" + SelectedIds + ")", conn);
        ...
        {
            SqlCommand cmd = new SqlCommand("Delete from Envelop where EnvelopId in(" + id + ")", conn);
            // SqlCommand cmd = new SqlCommand("delete from tblContactUs where Name='';", conn);
            conn.Open();
            cmd.ExecuteNonQuery();
            conn.Close();
